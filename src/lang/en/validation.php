...
return [
    ...
    'attributes' => [
        ...
        'reference' => 'Reference / Transaction note',
        'items' => 'Items list',
        'items.*.name' => 'Item name',
        'items.*.category' => 'Category',
        'items.*.description' => 'Item description',
        'items.*.image_url' => 'Item image',
        'items.*.base_price' => 'Base price',
        'items.*.source_item_key' => 'Source item key',
        'items.*.item_id' => 'Item ID',
        'items.*.quantity' => 'Quantity',
        'items.*.size_id' => 'Size ID',
        'items.*.topping_ids' => 'Toppings list',
        'items.*.topping_ids.*' => 'Topping ID',
        ...
        'allocations.*' => 'Member allocation',
        'restaurant' => 'Restaurant / Store name',
        ...
        'language' => 'Language',
        'settings' => 'Settings',
        'default_sponsor' => 'Default sponsor',
        'default_payment_account_id' => 'Default payment account',
        ...
        'room_url' => 'Room link',
        'sponsor_description' => 'Sponsorship policy description',
        'sponsor_type' => 'Sponsorship type',
        'sugar' => 'Sugar level',
        'toppings' => 'Toppings',
        'debt_ids' => 'Debt list',
        'debt_ids.*' => 'Debt ID',
