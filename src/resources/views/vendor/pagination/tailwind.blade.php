        ...
        <div class="hidden sm:flex-1 sm:flex sm:gap-2 sm:items-center sm:justify-between">
            ...
            <div>
                <p class="text-sm text-gray-700 leading-5 dark:text-gray-600">
                    {{-- One translatable sentence (word order differs between languages), numbers highlighted. --}}
                    ...
                    @else
                        {!! __('pagination.summary_count', [
                            'count' => '<span class="font-medium">'.e($paginator->count()).'</span>',
                            'total' => '<span class="font-medium">'.e($paginator->total()).'</span>',
                        ]) !!}
                    @endif
                </p>
