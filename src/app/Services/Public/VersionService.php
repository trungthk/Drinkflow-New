...
{
    /**
     * Thu thập và chuẩn bị dữ liệu hiển thị cho trang danh sách hoặc chi tiết phiên bản.
     *
     * @param  string|null  $version  Phiên bản cần tra cứu (ví dụ: 'v2.3.0'), hoặc null để lấy bản mới nhất
     * @return array<string, mixed>  Mảng dữ liệu view bao gồm danh sách phiên bản, bản hiện tại, trước/sau và URLs
     */
    public function getVersionPageData(?string $version = null): array
    {
    ...
    /**
     * Cung cấp danh sách phiên bản mặc định chuẩn theo thiết kế khi cơ sở dữ liệu chưa có dữ liệu.
     *
     * @return array<int, object>  Mảng các object mô tả các phiên bản mặc định
     */
