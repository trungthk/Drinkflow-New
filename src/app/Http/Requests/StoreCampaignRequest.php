...
class StoreCampaignRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sponsor_allocations.*.type' => ['required', 'in:per_item,budget,full'],
            'sponsor_allocations.*.amount' => ['nullable', 'integer', 'min:0'],
            'sponsor_allocations.*.description' => ['nullable', 'string', 'max:1000'],
