...
{
    /**
     * Display the global user orders page or list data.
     *
    ...
    public function index(Request $request): View|JsonResponse
    {
        ...
        if ($selectedStatus === 'paid') {
            ...
            $query->whereIn('status', ['submitted', 'confirmed', 'pending', 'ordering', 'ordered', 'delivering']);
        ...
        return view('user.global.orders', [
            'user' => $user,
            'orders' => $orders,
            'userRooms' => $userRooms,
    ...
    /**
     * JSON API query for orders history.
     *
     * @param Request $request
     * @return JsonResponse
     */
