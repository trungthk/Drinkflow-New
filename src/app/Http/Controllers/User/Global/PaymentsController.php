...
{
    /**
     * Display the payments & debt reconciliation page.
     *
        ...
        if ($request->wantsJson()) {
            return response()->json([
                'metrics' => [
                    ...
                    'paid_count' => $paidThisMonthCount,
                    'sponsor_received' => $totalSponsorReceived,
                ],
                'orders' => $displayedOrders->values(),
                'default_bank' => $defaultBank,
            ]);
        }

        return view('user.global.payments', [
            'user' => $user,
