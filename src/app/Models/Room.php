...
class Room extends Model
{
    ...
    public function roomSettings(): HasMany { return $this->hasMany(RoomSetting::class); }

    public function notificationChannels(): HasMany { return $this->hasMany(NotificationChannel::class); }

    public function admins(): BelongsToMany { return $this->belongsToMany(AdminAccount::class, 'admin_rooms', 'room_id', 'admin_id'); }
}
